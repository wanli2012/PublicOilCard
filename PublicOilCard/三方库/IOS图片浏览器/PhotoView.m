...
-(id)initWithFrame:(CGRect)frame withPhotoUrl:(NSString *)photoUrl{
    ...
    if (self) {
        ...
        [self.imageView sd_setImageWithURL:[NSURL URLWithString:photoUrl] placeholderImage:[UIImage imageNamed:kGOODS_PlaceHolder] options:0 progress:^(NSInteger receivedSize, NSInteger expectedSize){
