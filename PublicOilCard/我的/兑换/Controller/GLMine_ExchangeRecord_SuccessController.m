...
-(void)initdatasource{
    ...
    [NetworkManager requestPOSTWithURLStr:@"UserInfo/mark_list" paramDic:@{@"uid":[UserModel defaultUser].uid , @"token":[UserModel defaultUser].token , @"page" :[NSNumber numberWithInteger:self.page] ,@"status":@"1",@"back_type":[recordeManger defaultUser].recordeType} finish:^(id responseObject) {
