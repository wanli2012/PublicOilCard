...
-(void)initdatasource{
    ...
    [NetworkManager requestPOSTWithURLStr:kEXCHANGELIST_URL paramDic:@{@"uid":[UserModel defaultUser].uid , @"token":[UserModel defaultUser].token , @"page" :[NSNumber numberWithInteger:self.page] ,@"status":@"2",@"back_type":[recordeManger defaultUser].recordeType} finish:^(id responseObject) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.bottomConstent.constant = 0;
    cell.reasonLabelHeight.constant = 0;
    return cell;
