...
-(void)filte{
    ...
    QQPopMenuView *popview = [[QQPopMenuView alloc]initWithItems:@[@{@"title":@"非会员",@"imageName":@""}, @{@"title":@"会员",@"imageName":@""}] width:100 triangleLocation:CGPointMake([UIScreen mainScreen].bounds.size.width-30, 64+5) action:^(NSInteger index) {
